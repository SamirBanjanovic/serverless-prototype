...
namespace Serverless.Worker.Providers
{
    public static class ConfigurationProvider
    {
        ...
        public const string DockerUri = "http://0.0.0.0:2375";
        ...
        public const string ResponseTemplate = "https://[yoursite].azurewebsites.net/executions/{0}/respond";
        public const int InstanceCacheMinutes = 15;
        public const string ContainerUriTemplate = "http://{0}:8080/";
        public const string DockerNetworkName = "bridge";
